...
class TestNode(base.TestCase):
    def test_basic(self):
        ...
        self.assertTrue(n.allow_create)
        self.assertTrue(n.allow_fetch)
        self.assertTrue(n.allow_commit)
        self.assertTrue(n.allow_delete)
        self.assertTrue(n.allow_list)
        self.assertEqual('PATCH', n.commit_method)

    def test_instantiate(self):
        n = node.NodeDetail(**FAKE)
        self.assertEqual(FAKE['uuid'], n.uuid)
